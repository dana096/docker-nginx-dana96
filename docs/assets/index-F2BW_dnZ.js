 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Su{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const n=this.getProvider(t.name);if(n.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);n.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const n=new Cu(t,this);return this.providers.set(t,n),n}getProviders(){return Array.from(this.providers.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mf(e){tt(new He("platform-logger",t=>new ku(t),"PRIVATE")),tt(new He("heartbeat",t=>new Af(t),"PRIVATE")),ze(ir,xs,e),ze(ir,xs,"esm2017"),ze("fire-js","")}Mf("");var Df="firebase",Of="10.7.2";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wi="installations",Cd="installations-internal",Td=e=>{const t=e.getProvider("app").getImmediate(),n=Ed(t),r=gn(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Ad=e=>{const t=e.getProvider("app").getImmediate(),n=gn(t,wi).getImmediate();return{getId:()=>wd(n),getToken:s=>vd(n,s)}};function Sd(){tt(new He(wi,Td,"PUBLIC")),tt(new He(Cd,Ad,"PRIVATE"))}Sd();ze(ri,Lr);ze(ri,Lr,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eh{constructor(t){this.app=t}_delete(){return delete St[this.app.options.appId],Promise.resolve()}}let St={},Fs=[];const Ns={};let Un="dataLayer",th="gtag",zs,Ci,js=!1;function nh(){const e=[];if(gu()&&e.push("This is a browser extension environment."),mu()||e.push("Cookies are not available."),e.length>0){const t=e.map((r,s)=>`(${s+1}) ${r}`).join(" "),n=ue.create("invalid-analytics-context",{errorInfo:t});ie.warn(n.message)}}function rh(e,t,n){nh();const r=e.options.appId;if(!r)throw ue.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)ie.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw ue.create("no-api-key");if(St[r]!=null)throw ue.create("already-exists",{id:r});if(!js){Bd(Un);const{wrappedGtag:o,gtagCore:i}=jd(St,Fs,Ns,Un,th);Ci=o,zs=i,js=!0}return St[r]=Qd(e,Fs,Ns,t,zs,Un,n),new eh(e)}function sh(e=wf()){e=Go(e);const t=gn(e,tn);return t.isInitialized()?t.getImmediate():oh(e)}function oh(e,t={}){const n=gn(e,tn);if(n.isInitialized()){const s=n.getImmediate();if(Zt(t,n.getOptions()))return s;throw ue.create("already-initialized")}return n.initialize({options:t})}function ih(e,t,n,r){e=Go(e),Xd(Ci,St[e.app.options.appId],t,n,r).catch(s=>ie.error(s))}const Hs="@firebase/analytics",Vs="0.10.0";function ah(){tt(new He(tn,(t,{options:n})=>{const r=t.getProvider("app").getImmediate(),s=t.getProvider("installations-internal").getImmediate();return rh(r,s,n)},"PUBLIC")),tt(new He("analytics-internal",e,"PRIVATE")),ze(Hs,Vs),ze(Hs,Vs,"esm2017");function e(t){try{const n=t.getProvider(tn).getImmediate();return{logEvent:(r,s,o)=>ih(n,r,s,o)}}catch(n){throw ue.create("interop-component-reg-failed",{reason:n})}}}ah();Wc(su).mount("#app");const ch={apiKey:"AIzaSyCfjkP7NDWgRTL30Y7wngkj4qbu9lVMc2c",authDomain:"dana096-hello-vue.firebaseapp.com",projectId:"dana096-hello-vue",storageBucket:"dana096-hello-vue.appspot.com",messagingSenderId:"664267509585",appId:"1:664267509585:web:f8fe5a37143b6846920d70",measurementId:"G-GF3HCZX2QQ"},lh=Zo(ch);sh(lh);
